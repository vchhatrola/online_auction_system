...
function TermsAndConditions() {
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto', padding: '20px', backgroundColor: '#f9f9f9', border: '1px solid #ddd', borderRadius: '5px' }}>
      <h2 style={{ textAlign: 'center', marginBottom: '20px' }}>Terms and Conditions</h2>
      <div>
        <p style={{ textAlign: 'justify', marginBottom: '15px' }}><strong>1. Acceptance of Terms</strong><br />
        ...
        <p style={{ textAlign: 'justify', marginBottom: '15px' }}><strong>2. Description of the System</strong><br />
        ...
        <p style={{ textAlign: 'justify', marginBottom: '15px' }}><strong>3. User Conduct</strong><br />
        ...
        <p style={{ textAlign: 'justify', marginBottom: '15px' }}><strong>4. User Registration</strong><br />
        ...
        <p style={{ textAlign: 'justify', marginBottom: '15px' }}><strong>5. Intellectual Property</strong><br />
        ...
        <p style={{ textAlign: 'justify', marginBottom: '15px' }}><strong>6. User Content</strong><br />
        ...
        <p style={{ textAlign: 'justify', marginBottom: '15px' }}><strong>7. Privacy Policy</strong><br />
        ...
        <p style={{ textAlign: 'justify', marginBottom: '15px' }}><strong>8. Security Measures</strong><br />
        ...
        <p style={{ textAlign: 'justify', marginBottom: '15px' }}><strong>9. Disclaimer of Warranties</strong><br />
        ...
        <p style={{ textAlign: 'justify', marginBottom: '15px' }}><strong>10. Limitation of Liability</strong><br />
        ...
        <p style={{ textAlign: 'justify', marginBottom: '15px' }}><strong>11. Governing Law</strong><br />
        ...
        <p style={{ textAlign: 'justify', marginBottom: '15px' }}><strong>12. Changes to Terms</strong><br />
        ...
        <p style={{ textAlign: 'justify', marginBottom: '15px' }}><strong>13. Contact Information</strong><br />
